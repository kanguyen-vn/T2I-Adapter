...
class dataset_coco_box:
    def __init__(self, path_json, root_path_im, root_path_box, image_size,text_encoder):
        ...
        for file in data:
            ...
            self.files.append({"name": name, "sentence": file["caption"], "boxes": box_cords_tensor, "labels":labels})
